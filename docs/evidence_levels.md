...
| `in_process_snapshot_replay_equivalence_v1` | exact post-reset witness equality for conditions restored inside one live process | cross-process determinism, Isaac acceptance, and task success |
